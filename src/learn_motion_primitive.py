...
class ros_dmp:
    def __init__(self, trajectory_file):
        ...
        trajectory_path = "../data/recorded_trajectories/02_08"
        ...
        # Initiating DMP
        self.dmp = pydmps.dmp_discrete.DMPs_discrete(n_dmps=6, n_bfs=150, ay=np.ones(6)*10.0)
        self.pos = None
        self.vel = None
        self.acc = None
...
if __name__ == "__main__":
    ...
    TrajectoryFile = raw_input('Enter the trajectory file name: ')
    dmp = ros_dmp(trajectory_file=TrajectoryFile)
    WeightsFile = "weights_" + TrajectoryFile
    dmp.learn_dmp(file_name=WeightsFile)
